  ...
  return (
    ...
    <>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              ...
              <p className="fs-5 mb-5 text-light">
                Descubre los mejores eventos culturales y consigue tus entradas
              ...
              <div className="card-custom">
                ...
                <div className="p-4">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <span className="fs-4 fw-bold text-purple">Desde 25€</span>
                    <button className="btn btn-primary-custom btn-sm"  onClick={irAlEventos}>
                      Ver más
                    </button>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card-custom">
                ...
                <div className="p-4">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <span className="fs-4 fw-bold text-purple">Desde 30€</span>
                    <button className="btn btn-primary-custom btn-sm" onClick={irAlEventos}>
                      Ver más
                    </button>
                  </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card-custom">
                ...
                <div className="p-4">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <span className="fs-4 fw-bold text-purple">Desde 35€</span>
                    <button className="btn btn-primary-custom btn-sm" onClick={irAlEventos}>
                      Ver más
                    </button>
                  </div>
      ...
      <section className="py-5 bg-dark-custom">
        <div className="container">
          <h2 className="display-5 fw-bold mb-5" id="todos_eventos">Todos los Eventos</h2>

          <div className="row g-4">
            {/* Evento 1 */}
            
            <div className="col-lg-3 col-md-4 col-sm-6" onClick={irAlEventos}>
